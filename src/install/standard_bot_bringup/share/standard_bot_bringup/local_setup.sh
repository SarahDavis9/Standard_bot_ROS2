...
: ${AMENT_CURRENT_PREFIX:="/home/sarah/sb_ros2_ws/src/install/standard_bot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/standard_bot_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/standard_bot_bringup/environment/path.sh"
